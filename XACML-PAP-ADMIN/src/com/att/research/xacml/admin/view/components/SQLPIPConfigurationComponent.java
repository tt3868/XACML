...
import com.att.research.xacml.admin.jpa.PIPConfigParam;
...
public class SQLPIPConfigurationComponent extends CustomComponent implements FormChangedEventNotifier {
	...
	public static final String	CLASSNAME = "com.att.research.xacml.std.pip.engines.jdbc.JDBCEngine";
	...
	public static String[]	SQL_DRIVERS = new String[] {SQL_DRIVER_MYSQL, SQL_DRIVER_POSTGRESQL, SQL_DRIVER_H2, SQL_DRIVER_HYPER};
	...
	protected void initializeSQLDriverCombo() {
		...
		if (param != null) {
			...
			//
			if (this.comboBoxSQLDriver.getValue().equals(param.getParamValue()) == false) {
				//
