...
import com.att.research.xacml.admin.XacmlAdminAuthorization.AdminAction;
import com.att.research.xacml.admin.XacmlAdminAuthorization.AdminResource;
import com.att.research.xacml.admin.converters.XacmlConverterFactory;
...
import com.att.research.xacml.admin.model.MatchFunctionQueryDelegate;
import com.att.research.xacml.admin.util.RESTfulPAPEngine;
import com.att.research.xacml.api.XACML3;
import com.att.research.xacml.api.pap.PAPEngine;
import com.att.research.xacml.api.pap.PAPException;
import com.att.research.xacml.rest.XACMLRest;
import com.att.research.xacml.rest.XACMLRestProperties;
...
public class XacmlAdminUI extends UI implements PAPNotificationBroadcaster.PAPNotificationBroadcastListener {
	...
	private static Log logger	= LogFactory.getLog(XacmlAdminUI.class);
	...
	public static class Servlet extends VaadinServlet {
		...
		protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
			...
			if (request.getMethod().equals("PUT") && request.getParameter("PAPNotification") != null) {
				doPAPNotification(request, response);
				return;
			}
		 ...
		 * @throws IOException
		 */
		protected void doPAPNotification(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
			try {
				//
	...
	protected void init(VaadinRequest request) {
		...
		// Set our title
		//
		this.getPage().setTitle("AT&T Policy Engine Admin Console");
		//
