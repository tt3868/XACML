...
import com.att.research.xacml.admin.model.GitRepositoryContainer;
import com.att.research.xacml.admin.model.PolicyContainer;
import com.att.research.xacml.admin.util.AdminNotification;
import com.att.research.xacml.admin.util.JPAUtils;
import com.att.research.xacml.admin.view.windows.AttributeSelectionWindow;
import com.att.research.xacml.admin.view.windows.AttributeValueEditorWindow;
import com.att.research.xacml.admin.view.windows.ExpressionBuilderComponent;
import com.att.research.xacml.admin.view.windows.MatchEditorWindow;
import com.att.research.xacml.admin.view.windows.ObligationAdviceEditorWindow;
import com.att.research.xacml.admin.view.windows.PolicyEditorWindow;
import com.att.research.xacml.admin.view.windows.PolicySetEditorWindow;
import com.att.research.xacml.admin.view.windows.RuleEditorWindow;
import com.att.research.xacml.admin.view.windows.VariableDefinitionEditorWindow;
...
//						for (ObligationExpressionType old : ((ObligationExpressionsType) originalExpressions).getObligationExpression()) {
	...
	protected boolean clipboardPaste(final Object target, boolean performPaste) {
		...
		if (this.clipboardObject instanceof PolicySetType) {
			if (target instanceof PolicySetType) {
				doPaste = true;
			}
		}
		if (this.clipboardObject instanceof PolicyType) {
			if (target instanceof PolicySetType) {
				doPaste = true;
			}
		}
		if (this.clipboardObject instanceof RuleType) {
			if (target instanceof PolicyType) {
				doPaste = true;
			}
		}
